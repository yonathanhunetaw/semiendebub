...
export default function AdminLayout({ children }: Props) {
    ...
    const host = typeof window !== 'undefined' ? window.location.hostname.split('.')[0].toLowerCase() : 'admin';

    // Safety check to ensure we have a valid config, otherwise fallback to admin
    const isKnownSubdomain = host in subdomainConfigs;
    const activeKey: SubdomainType = isKnownSubdomain ? (host as SubdomainType) : 'admin';
            ...
            >
                ...
                <AdminSidebar
                    ...
                    sx={{
                        ...
                        '& .MuiDrawer-paper': { boxSizing: 'border-box', width: 260, borderRight: '1px solid', borderColor: 'divider' },
                    }}
                />
            </Box>
