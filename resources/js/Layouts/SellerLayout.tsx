import SellerSidebar from "@/Components/Navigation/Seller/SellerSidebar";
...
export default function SellerLayout({
    ...
    const hostParts =
        typeof window !== "undefined"
            ...
            : ["seller"];
    const detected = hostParts.length > 2 ? hostParts[0].toLowerCase() : "seller";
    const activeKey: SubdomainType =
        detected in subdomainConfigs ? (detected as SubdomainType) : "seller";
    ...
    return (
        <Box sx={{ display: "flex", bgcolor: "background.default", minHeight: "100vh" }}>
            <CssBaseline />
            <Head>
                <title>{`${config.label} | Seller`}</title>
                <link
                    rel="icon"
