...
export default function SharedLayout({ children }: { children: React.ReactNode }) {
    ...
    const detected = hostParts.length > 2 ? hostParts[0].toLowerCase() : 'shared';
    const activeKey: SubdomainType = (detected in subdomainConfigs) ? (detected as SubdomainType) : 'shared';
