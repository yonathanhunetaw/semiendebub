...
function AddShipmentDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
    ...
    const handleAdd = () => {
        // TODO: POST to admin.inventory.replenish.store with form data
        ...
        <Box sx={{ maxWidth: 720, mx: "auto" }}>
            ...
            <Stack direction="row" justifyContent="space-between" alignItems="flex-start" mb={3}>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                    ...
                    <Chip icon={<SyncAltIcon sx={{ fontSize: 14 }} />} label="ERP-SYNC: ACTIVE"
                        color="primary" size="small" sx={{ fontWeight: 700, fontFamily: "monospace", fontSize: 11 }} />
                </Stack>
            </Stack>
