...
function EditDrawer({
    ...
    const saveBase = () => wrap(async () => {
        await axios.patch(`/store-variants/${variant.id}`, {
            price:            basePrice,
    ...
    const addCustomerPrice = () => wrap(async () => {
        ...
        setCustomerPrices(prev => {
            ...
            const row: CustomerPrice = {
                ...
                customer_name:    data.customer?.name ?? `Customer #${data.customer_id}`,
                price:            data.price,
    ...
    const addSellerPrice = () => wrap(async () => {
        ...
        setSellerPrices(prev => {
            ...
            const row: SellerPrice = {
                ...
                seller_name:      data.seller?.name ?? `Seller #${data.seller_id}`,
                price:            data.price,
                discount_price:   data.discount_price,
                discount_ends_at: data.discount_ends_at,
            };
...
function Row({
    ...
    const handleSaved = (updated: Variant) => {
        ...
        setEditing(updated); // keep drawer open with latest data
    };
...
// Page
// ─────────────────────────────────────────────────────────────────────────────
export default function StoreShow({ store, inventory = [], customers = [], sellers = [] }: Props) {
