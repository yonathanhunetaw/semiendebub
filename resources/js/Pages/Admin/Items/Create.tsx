...
export default function Create({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        packaging: [
            { item_packaging_type_id: "" as string | number, quantity: 1 },
        ],
        images: [] as File[],
        status: "active",
    });
                ...
                {activeCreator !== uniqueId ? (
                    ...
                    <Stack direction="row" spacing={1} sx={{ mt: 1 }}>
                        ...
                        <Button
                            variant="contained"
                            size="small"
                            onClick={() => handleInlineSave(field, index)}
                            sx={{ bgcolor: "#3ea6ff" }}
                        >
                            Save
                        </Button>
            ...
            <Box sx={{ position: "fixed", top: 20, right: 20, zIndex: 9999 }}>
                <Fade in={!!successMsg}>
                    <Alert
                        ...
                        severity="success"
                        sx={{ bgcolor: "#1e3a1e", color: "#8dfb8d" }}
                    >
                        {successMsg}
                    </Alert>
                </Fade>
                                ...
                                >
                                    ...
                                    {data.images.length > 0 && (
                                        <Typography color="primary" mt={1}>
                                            {data.images.length} files staged
                                        </Typography>
                                    )}
                                </Box>
                            </Stack>
