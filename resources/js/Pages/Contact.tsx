...
export default function Contact() {
    ...
    // --------------------------------------------------------------------------------------------
    console.log("------------------------------------------------- Arrow Function and Scope");
    ...
    // ------------------------------------------------------------------------------------------
                                                     console.log("Page 21 - Object Literal Enhancement");
    ...
    // ------------------------------------------------------------------------------------------
                                                                                        console.log("Page 24");
    console.log("------------------------------------------------ Simple Promises with Fetch");
    ...
    console.log("--------------- Functional Programming with JavaScript -----------------");
    ...
    // ------------------------------------------------------------------------------------------
                                                                                     console.log("Page 32");
    console.log("----------------- What it means to be Functional ----------------------");
    ...
    // ------------------------------------------------------------------------------------------
                                                                                    console.log("Page 33");
    console.log("------------------ Imperative Versus Declarative ----------------------");
    ...
    let color_lawn = {
        ...
        rating: 0
                                                                                    ...
                                                                                    console.log("Page 37");
    const rateColor = function(color:any, rating:any) {
        return Object.assign({}, color, { rating: rating });
    };
    console.log(rateColor(color_lawn, 5).rating); // 5
    console.log('Original Object that hasn\'t mutated');
    console.log(color_lawn.rating); // 0

                                                                                    console.log("Page 37B");
    console.log('The same as above but using Spread Operator');
    const rateColorWithSpreadOperator = (color:any, rating:any) => ({
        ...color,
        rating
    });
    let updated_Color = rateColorWithSpreadOperator(color_lawn, 5);
    ...
    // Array.map
    // Object.keys
    // reduce and reduceRight functions
